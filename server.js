...
app.get('/player_info', function(req, res){
		var all = 'select id, name from football_players;';
		db.any(all)
			.then(function (data) {
...
app.get('/player_info/select_player', function(req, res){
		var all = 'select id, name from football_players;';
		var info = "select * from football_players where (id = " + req.body.player_id + ");";
		var games = "select * from football_games where players in " + req.body.player_id + ";";
		db.task('get-everything', task => {
	        return task.batch([
	            task.any(all),
	            task.any(info),
